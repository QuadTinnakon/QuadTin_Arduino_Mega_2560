...
float baroAltitudeold = 0.0;
float baro_vz = 0.0;
float baro_vzfilter = 0.0;
...
void requestRawPressure() {
    ...
    Wire.write(BMP085_READPRESSURECMD + (overSamplingSetting << 6));
    Wire.endTransmission();      
...
void baroInitialize() {
    ...
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_AC2);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    ac2 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_AC3);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    ac3 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_AC4);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    ac4 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_AC5);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    ac5 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_AC6);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    ac6 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_B1);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    b1 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_B2);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    b2 = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_MB);
    Wire.endTransmission();   
    Wire.requestFrom(BMP085_ADDRESS, 2);   
    mb = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_MC);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
    mc = (Wire.read() << 8) | Wire.read();      
    Wire.beginTransmission(BMP085_ADDRESS);
    Wire.write(BMP085_CAL_MD);
    Wire.endTransmission();    
    Wire.requestFrom(BMP085_ADDRESS, 2);    
